...
const {
	parse: worldSettingsFileParseStub
} = worldGenSettingsParserModule.default.file;
...
const worldGenSettingsModule = proxyquire(
	'./../../../src/api/settings/worldGen',
	{
		path: pathModule,
		'./../../utility/fs': fsModule,
...
describe('api/settings/worldGen', function () {
	...
	it('should parse and return the world gen settings', function (done) {
		...
		getWorldGenSettings({dfRootPath}).fork(done, (result) => {
